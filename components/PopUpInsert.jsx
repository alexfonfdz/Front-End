...
const PopupInsert = ({ onClose }) => {
    ...
    return (
        <div className="modal-container" id="modal">
            <div className="modal-content d-inline-flex justify-content-lg-center align-items-lg-center" style={{ background: 'rgb(251, 225, 147)', width: '40vw', height: '180vh', padding: '0px', borderRadius: '10px', border: '2px solid var(--bs-emphasis-color)', marginBottom: '0px' }}>
