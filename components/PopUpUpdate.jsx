...
const PopupUpdate = ({ onClose }) => {
  ...
  return (
    <div className="modal-container" id="modal">
      <div className="modal-content d-inline-flex justify-content-lg-center align-items-lg-center" style={{ background: 'rgb(251, 225, 147)', width: '400px', height: '1030px', padding: '75px', borderRadius: '10px', border: '2px solid var(--bs-emphasis-color)', marginTop: '10px' }}>
            <div style={{ width: '350px', textAlign: 'center', height: '500px' }}>
                ...
                <div style={{ marginTop: '30px' }}>
                    <p style={{ marginTop: '10px', fontFamily: 'Allerta', textAlign: 'left', fontSize: '18px' }}>Codigo</p>
                </div>
                <div>
                ...
                <div>
                    <div className="text-start" style={{ borderRadius: '5px', color: 'rgb(157,153,153)', background: '#D9D9D9', padding: '2px', border: '2px solid var(--bs-emphasis-color)', width: '330px' }}>
                        <input type="text" style={{ color: 'black', background: 'rgba(255,255,255,0)', borderColor: 'rgba(194,186,186,0)', outline:'none' }} />
                    </div>
                </div>
                <div style={{ marginTop: '30px' }}>
